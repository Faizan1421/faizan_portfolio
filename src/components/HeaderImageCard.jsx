...
export default function ImageCard() {
  return (
    <div className=" relative flex flex-col items-center justify-center size-[302px] lg:size-[310px]  bg-gradient-to-br from-blue-900 to-pink-900 rounded-lg cursor-pointer hover:scale-105 transition-all duration-500 ">
    ...
    <div className="flex flex-col items-center justify-center size-[300px]  lg:size-[300px] bg-white dark:bg-black rounded-lg">
     <Image
