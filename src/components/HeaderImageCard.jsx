...
export default function ImageCard() {
  return (
    <div className=" relative flex flex-col items-center justify-center w-[250px] h-[300px]  bg-gradient-to-br from-blue-900 to-pink-900 rounded-lg cursor-pointer hover:scale-105 transition-all duration-500 ">
    ...
    <div className="flex flex-col items-center justify-center w-[240px]   h-[290px] bg-white dark:bg-black rounded-lg">
     <Image
