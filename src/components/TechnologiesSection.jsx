...
function TechnologiesSection() {
  ...
  return (
    ...
    // </div>
    <div className="flex flex-col justify-center items-center w-full gap-10 px-2   md:px-20">
      <h1 className="text-center  font-bold text-5xl lg:text-7xl text-white p-0 m-0 translate-y-[-8px]">Technologies</h1>
      <div className="px-0 lg:px-52 xl:px-96">
      <p className="text-sm md:text-lg lg:text-xl  text-center translate-y-[-8px]">A powerful tech stack that enable seamless development of modern, 
